PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.sys.cam.zoom_panel=false \
    ...
    ro.com.google.clientidbase=android-fortuneship \
    ro.com.google.gmsversion=8.1_201810.go \
    ro.config.alarm_alert=Alarm_smartphones.mp3 \
    ro.config.default_message0=Message_smartphones.mp3 \
    ro.config.default_message1=Message_smartphones.mp3 \
    ro.config.default_message=Message_smartphones.mp3 \
    ro.config.low_ram=true \
    ro.config.message_sound0=Message_smartphones.mp3 \
    ro.config.message_sound1=Message_smartphones.mp3 \
    ro.config.message_sound=Message_smartphones.mp3 \
    ro.config.notification_sound=Message_smartphones.mp3 \
    ro.config.ringtone0=Ringtone_default.mp3 \
    ro.config.ringtone1=Ringtone_default.mp3 \
    ro.config.ringtone=Ringtone_default.mp3 \
    ...
    ro.sf.lcd_height=128 \
    ro.sf.lcd_width=72 \
    ro.sh.nv.config=fs286_band18_com_stm7285_spm6569 \
    ro.sh.project.name=sp7731e_fs286M71_cf1_ws507_s500_MSOTA_russia_64x8_GW18_HD.sh \
